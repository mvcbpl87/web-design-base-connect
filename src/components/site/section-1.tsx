...
export default function SiteSection1(){
 ...
 <div className="relative">
    <ImageTemplate 
     ...
     />
     <div className="bg-black/40 absolute inset-0 grid grid-cols-2">
    <div className="h-full flex flex-col justify-center px-20 space-y-[2rem]">
    <h1 className="text-wrap text-left text-white text-desktop-h1 leading-desktop-h1 ">
